Boot at 1970-01-01 00:00:00.432340408 UTC
...
[BENCH] Ring buffer write: 1157032.44 KB/s (102400 bytes in 0.09 ms)
...
[BENCH] IRQ count: 43
[BENCH] IRQ frequency: 497523.95 IRQ/s
[BENCH] Running RX ring buffer throughput test...
[BENCH] RX ring buffer read: 8046266.03 KB/s (65536 bytes in 0.01 ms)
[BENCH] Running RX ring buffer latency test...
[BENCH] RX latency (n=100): min=82ns avg=104ns P50=123ns P95=123ns P99=123ns
...
=== [S10] TX Throughput Baseline (write + tcdrain each iteration) ===
  ...
  diag=drain-each-size-64 n=100 avg_ms=5.607 p50_ms=5.599 p95_ms=5.625 p99_ms=5.636 max_ms=5.636 slow_gt10ms=0 slow_over_line_plus10ms=0 max_line_ratio=1.04
  policy=drain-each size=256 iters=100 bytes=25600 short_writes=0 drain_calls=100 drain_errors=0 last_drain_errno=0 elapsed_ms=2238 line_time_ms=2170.1 kbps=11.17 line_rate_pct=96.9
  diag=drain-each-size-256 n=100 avg_ms=22.385 p50_ms=21.989 p95_ms=22.015 p99_ms=50.868 max_ms=50.868 slow_gt10ms=100 slow_over_line_plus10ms=2 max_line_ratio=2.34
  ...
  diag=drain-each-size-1024 n=100 avg_ms=87.856 p50_ms=87.558 p95_ms=87.565 p99_ms=117.448 max_ms=117.448 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=1.35
  ...
  diag=drain-each-recheck-size-64 n=100 avg_ms=5.911 p50_ms=5.598 p95_ms=5.625 p99_ms=35.920 max_ms=35.920 slow_gt10ms=1 slow_over_line_plus10ms=1 max_line_ratio=6.62
...
=== [S11] TX Enqueue Cost (write loop, final drain outside timing) ===
  ...
  policy=no-drain size=64 iters=100 bytes=6400 short_writes=0 enqueue_ms=1 final_drain_ms=545 second_drain_ms=0 final_drain_rc=0 final_drain_errno=0 second_drain_rc=0 second_drain_errno=0 drain_calls=2 drain_errors=0 last_drain_errno=0 line_time_ms=542.5 enqueue_kbps=4807.13
  ...
  diag=s11-txdbg phase=final-drain size=64 ioctl_rc=0 user_calls=100 user_req=6400 user_acc=6400 ring_pop_calls=7 ring_pop_bytes=6400 hw_send_calls=274218 hw_send_bytes=6400 hw_send_zero=273818 hw_send_max_chunk=16 no_progress_budget=399 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  diag=s11-txdbg phase=second-drain size=64 ioctl_rc=0 user_calls=100 user_req=6400 user_acc=6400 ring_pop_calls=7 ring_pop_bytes=6400 hw_send_calls=274218 hw_send_bytes=6400 hw_send_zero=273818 hw_send_max_chunk=16 no_progress_budget=399 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  policy=no-drain size=256 iters=100 bytes=25600 short_writes=0 enqueue_ms=2 final_drain_ms=2183 second_drain_ms=0 final_drain_rc=0 final_drain_errno=0 second_drain_rc=0 second_drain_errno=0 drain_calls=2 drain_errors=0 last_drain_errno=0 line_time_ms=2170.1 enqueue_kbps=9521.79
  ...
  diag=s11-txdbg phase=final-drain size=256 ioctl_rc=0 user_calls=100 user_req=25600 user_acc=25600 ring_pop_calls=25 ring_pop_bytes=25600 hw_send_calls=1099122 hw_send_bytes=25600 hw_send_zero=1097522 hw_send_max_chunk=16 no_progress_budget=1599 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  diag=s11-txdbg phase=second-drain size=256 ioctl_rc=0 user_calls=100 user_req=25600 user_acc=25600 ring_pop_calls=25 ring_pop_bytes=25600 hw_send_calls=1099122 hw_send_bytes=25600 hw_send_zero=1097522 hw_send_max_chunk=16 no_progress_budget=1599 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  policy=no-drain size=1024 iters=100 bytes=65536 short_writes=36 enqueue_ms=6 final_drain_ms=5589 second_drain_ms=0 final_drain_rc=0 final_drain_errno=0 second_drain_rc=0 second_drain_errno=0 drain_calls=2 drain_errors=0 last_drain_errno=0 line_time_ms=5555.6 enqueue_kbps=10577.72
  diag=s11-txdbg-reset size=1024 ioctl_rc=0
  diag=s11-txdbg phase=enqueue size=1024 ioctl_rc=0 user_calls=293 user_req=74898 user_acc=65536 ring_pop_calls=0 ring_pop_bytes=0 hw_send_calls=0 hw_send_bytes=0 hw_send_zero=0 hw_send_max_chunk=0 no_progress_budget=0 ring_empty=0 copier_active=0 staged_bytes=0 transmitter_empty=1
  diag=s11-txdbg phase=final-drain size=1024 ioctl_rc=0 user_calls=293 user_req=74898 user_acc=65536 ring_pop_calls=65 ring_pop_bytes=65536 hw_send_calls=2815536 hw_send_bytes=65536 hw_send_zero=2811439 hw_send_max_chunk=16 no_progress_budget=4096 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  diag=s11-txdbg phase=second-drain size=1024 ioctl_rc=0 user_calls=293 user_req=74898 user_acc=65536 ring_pop_calls=65 ring_pop_bytes=65536 hw_send_calls=2815536 hw_send_bytes=65536 hw_send_zero=2811439 hw_send_max_chunk=16 no_progress_budget=4096 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1

=== [S12] TX Batch Drain (write N iterations, then tcdrain) ===
  diag=S12 pre_section_stdout_drain_ms=112 drain_errors=0 last_errno=0
...
=== [S13] TX writev Fragments (fragment aggregation witness) ===
  ...
  policy=writev-drain-each fragments=4 fragment_size=64 total_size=256 iters=100 bytes=25414 short_writes=1 drain_calls=100 drain_errors=0 last_drain_errno=0 elapsed_ms=2184 line_time_ms=2154.4 kbps=11.36 line_rate_pct=98.6
...
=== [S14] TX Small Packet Break-even (64/128/256 drain-each) ===
  ...
  diag=break-even-size-64 n=100 avg_ms=5.601 p50_ms=5.597 p95_ms=5.623 p99_ms=5.623 max_ms=5.623 slow_gt10ms=0 slow_over_line_plus10ms=0 max_line_ratio=1.04
  ...
  diag=break-even-size-128 n=100 avg_ms=11.363 p50_ms=11.074 p95_ms=11.090 p99_ms=39.932 max_ms=39.932 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=3.68
  ...
  diag=break-even-size-256 n=100 avg_ms=22.294 p50_ms=21.990 p95_ms=22.016 p99_ms=51.895 max_ms=51.895 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=2.39

=== [S20] TX Latency (single byte + tcdrain) ===
  diag=S20 pre_section_stdout_drain_ms=34 drain_errors=0 last_errno=0
  size=1 policy=drain-each n=100 avg_ms=0.188 p50_ms=0.187 p95_ms=0.194 p99_ms=0.241
...
=== [S21] TX Latency FIFO Boundary Matrix ===
  ...
  size=1 policy=drain-each n=100 avg_ms=0.188 p50_ms=0.187 p95_ms=0.194 p99_ms=0.244
  diag=fifo-size-1 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=15 policy=drain-each n=100 avg_ms=1.539 p50_ms=1.405 p95_ms=1.412 p99_ms=14.845
  diag=fifo-size-15 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=16 policy=drain-each n=100 avg_ms=1.627 p50_ms=1.490 p95_ms=1.493 p99_ms=15.189
  diag=fifo-size-16 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=17 policy=drain-each n=100 avg_ms=1.708 p50_ms=1.571 p95_ms=1.580 p99_ms=15.272
  diag=fifo-size-17 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=31 policy=drain-each n=99 avg_ms=2.934 p50_ms=2.781 p95_ms=2.807 p99_ms=16.466
  diag=fifo-size-31 drain_calls=99 drain_errors=0 last_drain_errno=0
  size=32 policy=drain-each n=100 avg_ms=3.010 p50_ms=2.867 p95_ms=2.892 p99_ms=16.383
  diag=fifo-size-32 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=33 policy=drain-each n=100 avg_ms=3.075 p50_ms=2.936 p95_ms=2.947 p99_ms=16.638
  diag=fifo-size-33 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=48 policy=drain-each n=100 avg_ms=4.374 p50_ms=4.233 p95_ms=4.259 p99_ms=17.921
  diag=fifo-size-48 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=49 policy=drain-each n=100 avg_ms=4.440 p50_ms=4.302 p95_ms=4.311 p99_ms=18.005
