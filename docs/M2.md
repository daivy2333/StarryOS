Boot at 1970-01-01 00:00:00.433164098 UTC
...
[BENCH] Ring buffer write: 1158681.42 KB/s (102400 bytes in 0.09 ms)
...
[BENCH] IRQ count: 42
[BENCH] IRQ frequency: 486646.20 IRQ/s
[BENCH] Running RX ring buffer throughput test...
[BENCH] RX ring buffer read: 8483563.10 KB/s (65536 bytes in 0.01 ms)
[BENCH] Running RX ring buffer latency test...
[BENCH] RX latency (n=100): min=82ns avg=104ns P50=123ns P95=123ns P99=246ns
...
=== [S10] TX Throughput Baseline (write + tcdrain each iteration) ===
  ...
  diag=drain-each-size-64 n=100 avg_ms=5.602 p50_ms=5.600 p95_ms=5.609 p99_ms=5.618 max_ms=5.618 slow_gt10ms=0 slow_over_line_plus10ms=0 max_line_ratio=1.04
  ...
  diag=drain-each-size-256 n=100 avg_ms=22.280 p50_ms=21.989 p95_ms=22.000 p99_ms=50.856 max_ms=50.856 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=2.34
  ...
  diag=drain-each-size-1024 n=100 avg_ms=87.853 p50_ms=87.552 p95_ms=87.578 p99_ms=117.431 max_ms=117.431 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=1.35
...
=== [S11] TX Enqueue Cost (write loop, final drain outside timing) ===
  ...
  policy=no-drain size=64 iters=100 bytes=6400 short_writes=0 enqueue_ms=1 final_drain_ms=545 final_drain_rc=0 final_drain_errno=0 drain_calls=1 drain_errors=0 last_drain_errno=0 line_time_ms=542.5 enqueue_kbps=4286.45
  ...
  diag=s11-txdbg phase=final-drain size=64 ioctl_rc=0 user_calls=100 user_req=6400 user_acc=6400 ring_pop_calls=7 ring_pop_bytes=6400 hw_send_calls=274287 hw_send_bytes=6400 hw_send_zero=273887 hw_send_max_chunk=16 no_progress_budget=399 slow_poll_exh=0 yield_exh=0 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  policy=no-drain size=256 iters=100 bytes=25600 short_writes=0 enqueue_ms=2 final_drain_ms=2183 final_drain_rc=0 final_drain_errno=0 drain_calls=1 drain_errors=0 last_drain_errno=0 line_time_ms=2170.1 enqueue_kbps=8877.57
  ...
  diag=s11-txdbg phase=final-drain size=256 ioctl_rc=0 user_calls=100 user_req=25600 user_acc=25600 ring_pop_calls=25 ring_pop_bytes=25600 hw_send_calls=1099219 hw_send_bytes=25600 hw_send_zero=1097619 hw_send_max_chunk=16 no_progress_budget=1599 slow_poll_exh=0 yield_exh=0 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
  policy=no-drain size=1024 iters=100 bytes=65536 short_writes=36 enqueue_ms=6 final_drain_ms=5589 final_drain_rc=0 final_drain_errno=0 drain_calls=1 drain_errors=0 last_drain_errno=0 line_time_ms=5555.6 enqueue_kbps=10251.57
  ...
  diag=s11-txdbg phase=final-drain size=1024 ioctl_rc=0 user_calls=293 user_req=74957 user_acc=65536 ring_pop_calls=65 ring_pop_bytes=65536 hw_send_calls=2815313 hw_send_bytes=65536 hw_send_zero=2811216 hw_send_max_chunk=16 no_progress_budget=4096 slow_poll_exh=0 yield_exh=0 ring_empty=1 copier_active=0 staged_bytes=0 transmitter_empty=1
...
=== [S13] TX writev Fragments (fragment aggregation witness) ===
  ...
  policy=writev-drain-each fragments=4 fragment_size=64 total_size=256 iters=100 bytes=25416 short_writes=1 drain_calls=100 drain_errors=0 last_drain_errno=0 elapsed_ms=2184 line_time_ms=2154.5 kbps=11.36 line_rate_pct=98.7

=== [S14] TX Small Packet Break-even (64/128/256 drain-each) ===
  diag=S14 pre_section_stdout_drain_ms=25 drain_errors=0 last_errno=0
  policy=drain-each size=64 iters=100 bytes=6400 short_writes=0 drain_calls=100 drain_errors=0 last_drain_errno=0 elapsed_ms=560 line_time_ms=542.5 kbps=11.15 line_rate_pct=96.8
  diag=break-even-size-64 n=100 avg_ms=5.601 p50_ms=5.599 p95_ms=5.608 p99_ms=5.619 max_ms=5.619 slow_gt10ms=0 slow_over_line_plus10ms=0 max_line_ratio=1.04
  ...
  diag=break-even-size-128 n=100 avg_ms=11.357 p50_ms=11.070 p95_ms=11.073 p99_ms=39.946 max_ms=39.946 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=3.68
  ...
  diag=break-even-size-256 n=100 avg_ms=22.293 p50_ms=21.995 p95_ms=22.008 p99_ms=51.880 max_ms=51.880 slow_gt10ms=100 slow_over_line_plus10ms=1 max_line_ratio=2.39

=== [S20] TX Latency (single byte + tcdrain) ===
  diag=S20 pre_section_stdout_drain_ms=34 drain_errors=0 last_errno=0
  size=1 policy=drain-each n=100 avg_ms=0.189 p50_ms=0.188 p95_ms=0.196 p99_ms=0.227
...
=== [S21] TX Latency FIFO Boundary Matrix ===
  ...
  size=1 policy=drain-each n=100 avg_ms=0.190 p50_ms=0.189 p95_ms=0.196 p99_ms=0.235
  diag=fifo-size-1 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=15 policy=drain-each n=100 avg_ms=1.554 p50_ms=1.419 p95_ms=1.430 p99_ms=14.864
  diag=fifo-size-15 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=16 policy=drain-each n=100 avg_ms=1.640 p50_ms=1.504 p95_ms=1.508 p99_ms=15.202
  diag=fifo-size-16 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=17 policy=drain-each n=100 avg_ms=1.719 p50_ms=1.582 p95_ms=1.585 p99_ms=15.290
  diag=fifo-size-17 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=31 policy=drain-each n=100 avg_ms=2.922 p50_ms=2.787 p95_ms=2.792 p99_ms=16.486
  diag=fifo-size-31 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=32 policy=drain-each n=100 avg_ms=3.007 p50_ms=2.869 p95_ms=2.877 p99_ms=16.570
  diag=fifo-size-32 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=33 policy=drain-each n=99 avg_ms=3.083 p50_ms=2.939 p95_ms=2.956 p99_ms=16.660
  diag=fifo-size-33 drain_calls=99 drain_errors=0 last_drain_errno=0
  size=48 policy=drain-each n=100 avg_ms=4.372 p50_ms=4.239 p95_ms=4.244 p99_ms=17.770
  diag=fifo-size-48 drain_calls=100 drain_errors=0 last_drain_errno=0
  size=49 policy=drain-each n=100 avg_ms=4.443 p50_ms=4.304 p95_ms=4.314 p99_ms=18.019
