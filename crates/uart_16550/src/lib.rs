...
use core::{cmp, hint, num::NonZeroU8, ptr::NonNull};

#[cfg(any(target_arch = "x86", target_arch = "x86_64", doc))]
use crate::backend::{PioBackend, PortIoAddress};
use crate::{
    backend::{Backend, MmioAddress, MmioBackend},
    spec::{
        FIFO_SIZE, NUM_REGISTERS, calc_baud_rate, calc_divisor,
        registers::{DLL, DLM, FCR, IER, ISR, LCR, LSR, MCR, MSR, SPR, offsets},
    },
};
pub use crate::{config::*, error::*, tty::*};
