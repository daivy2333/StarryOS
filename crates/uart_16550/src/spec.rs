...
mod errors {
    ...
    impl Display for NonIntegerBaudRateError {
        fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
            write!(
                f,
                "Input values do not result in even (integer representable) baud rate! \
                 frequency={}, divisor={}, prescaler_division_factor={:?}",
    ...
    impl Display for NonIntegerDivisorError {
        fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
            write!(
                f,
                "input values do not result in even (integer representable) baud rate! \
                 frequency={}, baud_rate={}, prescaler_division_factor={:?}",
