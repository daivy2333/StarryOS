...
// T-Head C9xx PTE extension flags for normal memory:
// SH (shareable) | B (bufferable) | C (cacheable).
//
// Without these bits, D1/C906 can raise Store/AMO access fault when early
// axruntime code performs atomic operations on DDR-backed .bss.
