...
> Branch: net-k3
> Created: 2026-07-25
> Status: [ARCHIVED 2026-08-09] — T01-T13、PCI-first 与 VF2/DWMAC 固定分组已过时；不得作为当前 Plan 清单

本文保留 2026-07-25 的原始知识缺口，用于追溯早期规划。当前 QEMU 路线、目标板事实 Gate 和 Plan 前置问题以 [tasks](../../docs/tasks.md)、R23、R25、R41 及对应 change 为准；旧条目的 `open` 不表示当前仍有同名阻塞。
...
- [R23] `../async-network-project-overview.md` — 网络开发总览
- [R41] `../starryos-network-development-strategy.md` — 实施探索
- [R25] `../arceos-async-network-driver-analysis.md` — ArceOS 网卡分析
- [R42] `starryos-network-delivery-estimate.md` — 同批归档的历史交付估算
- [tasks] `../../docs/tasks.md` — 当前 milestones 和 Gate
