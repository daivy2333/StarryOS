...
<!-- A10 --> ### 2026-05-25 - Milestone 分期策略——6+1 期，先独立后统一

- **决策**: M0~M6 七期规划，M0-M2 独立验证，M3 统一 Console，M4 性能，M5 真板，M6 DMA
- **原因**: 降低集成风险，先验证中断驱动核心路径再做统一；性能优化需在稳定基础上进行；真板验证依赖硬件资源
- **影响**: M0-M2 可在 QEMU 上独立开发测试；M3 风险最高需谨慎；M4-M6 在 M2 稳定后推进
- **替代方案**:
  - ❌ 一步到位替换 Console — 调试困难，风险高
  - ❌ 跳过独立验证 — 不稳定基础做统一容易出问题
  - ✅ 先独立后统一 — 每期有明确 Gate，渐进演化
