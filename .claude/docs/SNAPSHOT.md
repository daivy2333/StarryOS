...
> 分支：uart-16550-lichee — Q20 benchmark gap closure 已完成；活跃 change 剩 q20-benchmark-gap-closure 待归档与 q17-smp-memory-ordering 多 hart deferred

---

## 当前状态

**分支**: uart-16550-lichee（Q19/Q19B/Q19C D1 真板异步 UART 验证已结束；Q20 TX latency/jitter/counter 补测完成；Q17 QEMU 修复完成，multi-hart 复验待 Q24）
...
**当前待推进**:
- Q21~Q23：UART completion queue，mmap user ring/zero-copy，性能决策。
