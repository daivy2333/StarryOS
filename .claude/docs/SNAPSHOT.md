...
**分支**: uart-16550-lichee（Q19/Q19B/Q19C D1 真板异步 UART 验证已结束；Q17 QEMU 修复完成，multi-hart 复验待 Q24）
...
**当前待推进**:
- Q20~Q23：QEMU+D1 latency/jitter/CPU/RX 补测，UART completion queue，mmap user ring/zero-copy，性能决策。
