...
No follow-up iteration is required in Q31. The Async UART measurement and evidence
scope is complete; the Console port and cross-branch comparison move to the
independent `q32-console-cpu-efficiency-benchmark` change approved on 2026-07-22.

**Findings**

1. The optimized Async implementation is anchored at commit
   `7d44cb173a7a5e8e0584c28d7976ded1a4d882f7`; the benchmark and D1 time-source
   hashes match the declared provenance.
2. The current QEMU and D1 logs contain complete S41/S42/S43 samples and terminal
   completion markers. No failed byte-integrity sample, drain failure, or timeout
   was accepted into the summaries.
3. The declared limitations remain valid: `/proc/instret` is a hart-wide CPU-work
   proxy rather than CPU utilization, and unavailable build metadata is covered by
   repository and artifact hashes.
4. Adding a Console iteration to Q31 would mix two branch-specific implementation
   lifecycles. Q32 will consume Q31's frozen workload, completion-point, timer, and
   evidence contract without reopening the Async implementation.

**Evidence**

- `openspec validate q31-async-uart-cpu-efficiency-benchmark --strict`: PASS.
- `tests/benchmark.c`: `4ad658f3bfa4f41555a9e9a9a35c7bd0b2c0b080021220fd0a2668ec63b91da6`.
...
- Current QEMU log: `a9ce8a34431ff6b9a609ffde83da2096228f17c37c3f900ec35f3c10939ce8ef`.
- Current D1 log: `50a2a87666045c1379391bec46e3453026967e028fa586abbcae8155576f0789`.

**Follow-up Decision**

Q31 remains the immutable Async evidence provider. Q32 owns all Console product-code
changes, Console QEMU/D1 evidence, and the final side-by-side report. A Q32 result
must reference the Q31 source and log hashes above; it must not edit or regenerate
the accepted Async evidence merely to make the comparison look uniform.

**Next Iteration**

None in Q31. Continue with
`openspec/changes/q32-console-cpu-efficiency-benchmark/iterations/000-initial.md`.
