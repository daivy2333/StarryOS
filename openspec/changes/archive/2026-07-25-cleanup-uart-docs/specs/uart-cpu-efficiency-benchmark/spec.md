...
Define CPU-efficiency benchmark measurement contract for Async UART: D1 time conversion accuracy, submission/completion separation, instret-based CPU-work, compute overlap, timer overshoot, and TX counter proxy semantics.
