...
Define Console CPU-efficiency benchmark measurement contract: D1 time conversion fix, shared measurement contract with Q31 Async, synchronous-write semantics, Console capability state, QEMU/D1 evidence provenance, and hash-locked Async/Console comparison rules.
