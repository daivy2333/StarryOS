...
| <!-- R10 --> `[ARCHIVED 2026-07-11]` `.claude/analysis/_archive/2026-07-11-q19c-d1-async-uart-closeout/q19c-lichee-full-starryos-benchmark.md` | Q19C benchmark 探究：先补 benchmark evidence cleanup（`benchmark.c` manifest、QEMU/真板参数对齐、RX witness、64B 小包优化探索），再从 Q19B embedded userbench 推进到 D1 memory-root path loading；2026-07-11 方向更新后，Q19C 收敛为 D1 async UART 性能验证，shell/SDMMC/rootfs 不再作为 gate |
