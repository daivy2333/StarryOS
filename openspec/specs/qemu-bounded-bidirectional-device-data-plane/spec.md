# qemu-bounded-bidirectional-device-data-plane Specification

## Purpose
TBD - created by archiving change ms05-qemu-bounded-bidirectional-device-data-plane. Update Purpose after archive.
## Requirements
