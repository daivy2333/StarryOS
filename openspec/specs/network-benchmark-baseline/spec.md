# network-benchmark-baseline Specification

## Purpose

定义跨 QEMU、真板、polling 和 async treatment 复用的网卡 workload、完成点、指标、Evidence 与 A/B 比较资格。规范描述目标测试口径，不表示每项基础设施或运行证据已经完成；当前覆盖状态以 R49 和 I16 为准。
